...
public class NonSnapshotCommitMojoTest {
  ...
  public void testCommit() throws Exception {
    ...
    when(this.mockMavenPomHandler.readArtifact(pom1)).thenReturn(new MavenModule(pom1, "con.non-blocking.tests", "test-all", "1.2.3"));
    when(this.mockMavenPomHandler.readArtifact(pom2)).thenReturn(new MavenModule(pom1, "con.non-blocking.tests", "test1", "1.1.1"));
    when(this.mockMavenPomHandler.readArtifact(pom3)).thenReturn(new MavenModule(pom3, "con.non-blocking.tests", "test2", "2.2.2"));
    when(this.mockMavenPomHandler.readArtifact(pom4)).thenReturn(new MavenModule(pom4, "con.non-blocking", "test3", "3.3.3"));
  ...
  public void testCommitIgnoreDuplicateEntries() throws Exception {
    ...
    when(this.mockMavenPomHandler.readArtifact(pom1)).thenReturn(new MavenModule(pom1, "con.non-blocking.tests", "test1", "1.1.1"));
    when(this.mockMavenPomHandler.readArtifact(pom2)).thenReturn(new MavenModule(pom2, "con.non-blocking.tests", "test2", "2.2.2"));
    when(this.mockMavenPomHandler.readArtifact(pom3)).thenReturn(new MavenModule(pom3, "con.non-blocking.tests", "test3", "3.3.3"));
